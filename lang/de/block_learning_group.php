...
$string['mysessions'] = 'Meine Lerngruppen';
$string['publicsessions'] = 'Öffentliche Lerngruppen';
$string['bookingfull'] = 'Keine Plätze mehr verfügbar';
$string['date'] = 'Datum';
$string['title'] = 'Titel';
$string['time'] = 'Uhrzeit';
...
$string['details_help'] = 'In diesem Textfeld können Sie Details zur Lerngruppe eintragen.';
...
$string['sessiondatetimeknown_help'] = 'Wenn bereits Termine für die Lerngruppe bekannt sind, können Sie diese hier angeben.';
$string['datetimeknownhinttext'] = 'Gibt es feste Sitzungstermine oder handelt es sich um ein Ad-Hoc-Meeting?';
$string['timestart'] = 'Uhrzeit Anfang';
$string['timefinish'] = 'Uhrteit Ende';
$string['dateremove'] = 'Termin entfernen';
...
$string['timerequested'] = 'Anfrage-Zeit';
$string['decidelater'] = 'Später entscheiden';
$string['decline'] = 'Ablehnen';
$string['approve'] = 'Zustimmen';
$string['cancellations'] = 'Kündigungen';
$string['timesignedup'] = 'Kündigungs-Zeit';
$string['timecancelled'] = 'Zeit der Kündigung';
$string['cancelreason'] = 'Kündigungs-Grund';
$string['updaterequests'] = 'Anfragen aktualisieren';
...
';
$string['setting:defaultrequestinstrmngrdefault'] = 'Sie ([firstname] [lastname]) wurden gerade  in eine Lerngruppe eingeladen.

Lerngruppe:   [learning_group_title]
...
Sie können die Teilnahme über diesen Link bestätigen:
